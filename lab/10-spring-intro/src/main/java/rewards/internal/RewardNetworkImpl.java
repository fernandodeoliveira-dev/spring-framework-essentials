...
public class RewardNetworkImpl implements RewardNetwork {
	...
	public RewardConfirmation rewardAccountFor(Dining dining) {
		...
		final var amount = restaurant.calculateBenefitFor(account, dining);
		final var contribuition = account.makeContribution(amount);

		accountRepository.updateBeneficiaries(account);

		return rewardRepository.confirmReward(contribuition, dining);
	}
}